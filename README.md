...
- an importable `operator_console` Storybook that renders the invoice-draft, issued-invoice, issued-credit-note, collection-case, collection-aging, account-statement, rated-spend, spend-budget, payment-intent, payment-receipt, credit-adjustment, rate-card, usage-event, rating-run, tax-assessment, and posting-receipt-observation presentment contracts with design tokens and exact-decimal fixtures;
