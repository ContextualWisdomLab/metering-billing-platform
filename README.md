...
- a normalized PostgreSQL 18 core plus usage-identity, rating-run, invoice-draft, journal-proposal, collection-case, payment-intent, payment-receipt, posting-receipt-observation, credit-adjustment, spend-budget, rate-card-catalog, tax-assessment, credit-tax-unwind, tenant-api-credential, webhook-outbox, issued-invoice, issued-credit-note, late-adjustment, late-adjustment-application, and late-adjustment-rating migrations with tenant-scoped attribution constraints;
