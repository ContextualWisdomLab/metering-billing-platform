...
- a durable PostgreSQL usage-to-issued-invoice vertical: rate-card versions, rating runs, invoice drafts, issued-invoice lines, optional tax snapshots, and an atomic `invoice.issued` webhook outbox replay path;
