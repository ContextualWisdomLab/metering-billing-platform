...
- the late-adjustment presentment, application, and rating contracts, tenant-scoped item/list reads, nested application/rating commands, recorded-at/ID keyset pagination, and explicit `apply_late_adjustment`, `rate_late_adjustment`, then `record_invoice_adjustment` actions;
