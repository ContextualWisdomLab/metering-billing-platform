...
7. Rate stored usage through `metering_billing.UsageRatingService` so a tenant window and rate-card version produce an exact, replayable invoice-intent total. Do not draft invoices or post journals from rating.
