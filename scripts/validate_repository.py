...
REQUIRED_FILES = (
    ...
    "schemas/reconciliation-exception-aging.schema.json",
    ...
    "database/migrations/0047_fx_conversion_rate_integrity.sql",
    "database/migrations/0047_reconciliation_fact_immutability.sql",
    "database/migrations/0049_late_adjustment.sql",
    "database/migrations/0050_late_adjustment_replay.sql",
