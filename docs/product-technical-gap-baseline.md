...
| #146 | Canonical Python/Rust/TypeScript producer SDK references and CloudEvents conformance vector for #90 | `develop` | `b77905af6051d559f0a4fa64815e245a810ca402`; open, blocked and review required after receipt-binding and usage-presentment remediation; current hosted checks were pending at snapshot, zero unresolved review threads, and zero qualifying approvals |
