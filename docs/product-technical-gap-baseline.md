...
| #146 | Canonical Python/Rust/TypeScript producer SDK references and CloudEvents conformance vector for #90 | `develop` | `67d211e46c9c6809a79f095bc71af0e9e86f9f43`; open, blocked after the #147 stacked merge; normal analysis/security checks passed, current OpenCode check failed for lack of a current-head verdict, provider reviews were still pending at snapshot, and zero qualifying approvals |
