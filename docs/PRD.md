...
- Operators inspect rated product, project, credential, principal, or cost-center spend, then draft an invoice. HTTP presentment does not capture cards, write money, or call AIS. A spend-budget write is a later slice.
