...
- Operators inspect rated product, project, credential, or principal spend, then draft an invoice. HTTP presentment does not capture cards, write money, or call AIS. `group_by=cost_center` is a later slice.
