...
The published resolution contract requires a positive, non-boolean contract
version, while the referenced line contract derives and validates its complete
ordered exception tuple before persistence.
