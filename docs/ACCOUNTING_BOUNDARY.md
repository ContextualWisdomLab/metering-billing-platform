...
Usage ingestion writes commercial usage facts only.  Rating writes invoice-intent totals from those facts.  Neither path emits a journal proposal or marks any accounting document as posted.
