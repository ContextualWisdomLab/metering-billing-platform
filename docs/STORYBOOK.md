...
Customer copy on every journal proposal: validated cash, invoice-draft, leftover, leftover-apply, leftover-refund, write-off, or unused invoice-void amount and the next operator action. Let AIS pull the validated journal.
...
| JournalProposal | `src/journal_proposal.js` | `validated_morning_cash_journal.json`, `validated_morning_invoice_draft_journal.json`, `validated_taxed_invoice_draft_journal.json`, `validated_morning_leftover_journal.json`, `validated_morning_leftover_apply_journal.json`, `validated_morning_leftover_refund_journal.json`, `validated_morning_write_off_journal.json`, `validated_unused_invoice_void_journal.json` |
