...
Customer copy on every journal proposal: validated cash, invoice-draft, leftover, leftover-apply, leftover-refund, or write-off amount and the next operator action. Let AIS pull the validated journal.
